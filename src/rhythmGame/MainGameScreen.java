    ...
    {       
        ...
        try
        {
        	if(this.song.name.equals("freely tomorrow")) {
        		...
        		test = new FileInputStream("C:\\Users\\hq\\eclipse-workspace\\FinalProject.zip_expanded\\FinalProject-master\\src\\rhythmGame\\ÃÎµÆÁý.wav");
	...
	private void findLabel(int i) {
        for (int j = 0; j<notes.length; j++ ) {
            ...
            if(notes[j].x==i && notes[j].y>450 & notes[j].y<500 & notes[j].hit == 0) {
                ...
                //----
                showAccuracy("C:\\Users\\Ë¼Ò£\\IdeaProjects\\FinalProject\\src\\rhythmGame\\img_and_audio\\perfect.png");    
                return;
            }
          ...
          //good
                ...
                showAccuracy("C:\\Users\\Ë¼Ò£\\IdeaProjects\\FinalProject\\src\\rhythmGame\\img_and_audio\\Good1.png");
